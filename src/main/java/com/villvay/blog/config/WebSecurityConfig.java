...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .hasAuthority("ADMIN")
                .antMatchers("/blog/author/{id}/post")
                .hasAuthority("USER")
                .antMatchers("/blog/author/{id}/comment")
                .hasAuthority("USER")
                .antMatchers("/blog/author/**")
                .hasAuthority("USER")
                .antMatchers("/blog/post/all")
                .hasAuthority("USER")
                .antMatchers("/blog/post/{id}")
                .hasAuthority("USER")
                .antMatchers("/blog/post/{id}/comment")
                .hasAuthority("USER")
                .antMatchers("/blog/post/**")
                .hasAuthority("USER")
                .antMatchers("/blog/comment/{id}")
                .hasAuthority("USER")
                .antMatchers("/blog/comment/all")
                .hasAuthority("USER")
